...
<html>
<head>
	<link rel="shortcut icon" type="image/png" href="mentor.png">
...
mysqli_select_db($conn,"id5097464_mydb");
  ...
  if(isset($_POST['login']))
  {
	$username=$_POST['username'];
  	...
  	$aadcheck="SELECT * FROM mentor WHERE username='$username' AND password='$password'  ";
  	...
  	if($logyes == 1)
  	{
  		...
  		echo("<script>location.href ='mentorextract.php?';</script>");
  	}
  	else
  	{
...
<div class="form-group" style="width: 30%; margin: 0 auto; padding-top: 100px;">
		<form method="post" action="mentorlogin.php"><br><br><br><br><br><br><br>
		<img src="mentoricon.png" alt="mentor" width="100" height="100" align="middle"><br>
		<label class="control-label col-sm-2">LOGIN</label>
		<input type="text" name="username" id="username" class="form-control" placeholder="mentor name"><br>
